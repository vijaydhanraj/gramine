...
def MeasureDjangoV2(python, options):
    bm_path = Relative("performance/bm_django_v2.py", python, options)
    django_path = Relative("lib/Django-1.5", python, options)
